...
(function(){
    ...
    function onMutation(mutations, observer){
        mutations.forEach(mutation => {
            ...
            if(mutation.target.tagName.toLowerCase() === "video" && mutation.attributeName === "src" && newAttributeValue !== ""){
                const videoUrl = newAttributeValue;
                console.info("Video URL is "+videoUrl);

                $('.videoplayer_controls').append($("<div>")
