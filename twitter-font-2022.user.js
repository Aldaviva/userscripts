...
html:has(> head > link[rel = 'canonical'][href = 'https://twitter.com/home']) > body nav a[data-testid = 'AppTabBar_Home_Link'] svg.filled {
    display: inline-block;
}

html:has(> head > link[rel = 'canonical'][href = 'https://twitter.com/home']) > body nav a[data-testid = 'AppTabBar_Home_Link'] svg.stroked {
    display: none;
}
`;
